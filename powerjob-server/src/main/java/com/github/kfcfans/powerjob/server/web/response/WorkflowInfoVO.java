...
public class WorkflowInfoVO {
    ...
    public static WorkflowInfoVO from(WorkflowInfoDO wfDO) {
        ...
        // 格式化时间
        vo.setVersions(DateFormatUtils.format(wfDO.getGmtCreate(), OmsConstant.TIME_PATTERN_VERSIONS));
        vo.setGmtModified(DateFormatUtils.format(wfDO.getGmtModified(), OmsConstant.TIME_PATTERN));
        return vo;
    }
}
