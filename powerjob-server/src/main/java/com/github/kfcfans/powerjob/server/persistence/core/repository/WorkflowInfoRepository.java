...
public interface WorkflowInfoRepository extends JpaRepository<WorkflowInfoDO, Long> {
    ...
    // 对外查询（list）三兄弟 +1兄弟
    Page<WorkflowInfoDO> findByStatusNot( int nStatus, Pageable pageable);
    ...
    Page<WorkflowInfoDO> findByStatusNotAndWfNameLike( int nStatus, String condition, Pageable pageable);
