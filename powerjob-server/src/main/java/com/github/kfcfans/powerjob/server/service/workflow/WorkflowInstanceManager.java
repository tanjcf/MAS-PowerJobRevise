...
public class WorkflowInstanceManager {
    ...
    public Long create(WorkflowInfoDO wfInfo, String initParams) {
        ...
        newWfInstance.setVersions(wfInfo.getGmtCreate());
    ...
    public void start(WorkflowInfoDO wfInfo, Long wfInstanceId, String initParams) {
        ...
        if (instanceConcurrency > wfInfo.getMaxWfInstanceNum()) {
            onWorkflowInstanceFailed(wfInstanceInfo,String.format(SystemInstanceResult.TOO_MUCH_INSTANCE, instanceConcurrency, wfInfo.getMaxWfInstanceNum()));
            return;
        }
    ...
    private void onWorkflowInstanceFailed(String result, WorkflowInstanceInfoDO wfInstance) {
        ...
        try {
            workflowInfoRepository.findById(wfInstance.getWorkflowId()).ifPresent(wfInfo -> {
                ...
                AlarmCenter.alarmFailed(content, userList,wfInfo.getWfName(),"");
            });
     ...
     * @param result
     */
    private void onWorkflowInstanceFailed(WorkflowInstanceInfoDO wfInstance,String result) {
