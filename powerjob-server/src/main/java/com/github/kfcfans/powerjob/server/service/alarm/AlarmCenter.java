...
public class AlarmCenter {
    ...
    public static void alarmFailed(Alarm alarm, List<UserInfoDO> targetUserList,String wfName,String jobName) {
        POOL.execute(() -> BEANS.forEach(alarmable -> {
            try {
                alarmable.onFailed(alarm, targetUserList,wfName,jobName);
            }catch (Exception e) {
