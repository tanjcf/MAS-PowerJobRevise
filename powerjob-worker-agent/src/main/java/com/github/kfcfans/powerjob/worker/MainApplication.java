...
public class MainApplication implements Runnable {
    ...
    @Option(names = {"-f","--file"},description = "worker-agent's file path",required = true)
    private int filePort = 27778 ;

    @Option(names = {"-u","--url"},description = "worker-agent's url path",required = true)
    private String urlPath = "/home/worker";
    ...
    public void run() {
        ...
        try {
            ...
            cfg.setUrlPath(urlPath);
            cfg.setFilePort(filePort);
